...
public class CarportSvg {
    ...
    public CarportSvg(Context ctx) {
        ...
        double viewboxWidth = this.carportLength + (3 * padding); // Added padding to ensure it fits visually
        double viewboxHeight = this.carportWidth - (-20.0) + (2 * padding); // Added padding to ensure it fits visually
    ...
    public void addPoles() {
        ...
        double distributionEnd = this.carportLength - 30.0; // 30 cm from the back (right)
        ...
        for (int i = 0; i < polesPerRow; i++) {
            ...
            // Draw top poles (-3.5 is for the visual perfectionism).
            carportSvg.addRectangle(poleX, 35.0 - 3.5, 9.7, 9.7, "stroke-width:1px; stroke:#000000; fill:#000000;");
            // Draw the bottom (+1.5 is for the visual perfectionism).
    ...
    private void addDimensions() {
        // Line in the top (from first pole to the last)
        ...
        // Line to the right (the whole carport width)
        ...
        // Line in the top (the whole carport length)
        ...
        // Line that shows the width between poles
